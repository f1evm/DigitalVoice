...
const uint32_t __code axradio_phy_chanfreq[1] = { 0x1b100001 };
...
const int32_t __code axradio_phy_maxfreqoffset = 2724;
...
const uint32_t __code axradio_sync_slave_rxadvance[] = { 686, 649, 727 };// 20.918ms, 19.788ms, 22.167ms
const uint32_t __code axradio_sync_slave_rxwindow[] = { 700, 626, 782 }; // 21.346ms, 19.086ms, 23.844ms
