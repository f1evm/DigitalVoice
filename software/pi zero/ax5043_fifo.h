...
uint8_t fifo_write_data(AX5043_t* self, uint8_t* data, size_t len)
{
    ...
    printf("\t\tFIFOSTAT    : %02h",  ax5043_register_read(AX_REG_FIFOSTAT);
    printf("\t\tFIFODATA    : %02h",  ax5043_register_read(AX_REG_FIFODATA);
    printf("\t\tFIFOCOUNT1  : %02h",  ax5043_register_read(AX_REG_FIFOCOUNT1);
    printf("\t\tFIFOCOUNT0  : %02h",  ax5043_register_read(AX_REG_FIFOCOUNT0);
    printf("\t\tFIFOFREE1   : %02h",  ax5043_register_read(AX_REG_FIFOFREE1);
    printf("\t\tFIFOFREE0   : %02h",  ax5043_register_read(AX_REG_FIFOFREE0);
    printf("\t\tFIFOTHRESH1 : %02h",  ax5043_register_read(AX_REG_FIFOTHRESH1);
    printf("\t\tFIFOTHRESH0 : %02h",  ax5043_register_read(AX_REG_FIFOTHRESH0);
